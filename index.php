...
<link rel="stylesheet" href='<?php echo get_template_directory_uri()?>/assets/css/media.css'>
      <main class="main">
                        ...
                        <div class="firstscreen__bottomRight">
                            <div class="firstscreen__bottomRightWrap">
                                <div class="firstscreen__bottomRightTxt">
                                    ...
                                    <h4>Убрать стресс и нервную торговлю в акциях</h4>
                                    <h4>Реализовывать идеи через опционы или в сочитании с акциями</h4>
                                    <h4>Структурировать знания по опционам</h4>
                ...
                <div class="container">
                    ...
                    <div class="perks__content">
                        <div class="perks__block">
                            ...
                            <img src="<?php echo get_template_directory_uri()?>/assets/source/perks/1.png" alt="" class="perks__blockPic">
                        </div>

                        <div class="perks__block">
                            <p>Различный срок торговли: среднесрочные и краткосрочные сделки втч недельные</p>
                            <img src="<?php echo get_template_directory_uri()?>/assets/source/perks/2.png" alt="" class="perks__blockPic">
                        </div>

                        <div class="perks__block">
                            <p>Готовые стратегии на все фазы рынка : направленные, полунаправленые , продажа волатильности , IV crash</p>
                            <img src="<?php echo get_template_directory_uri()?>/assets/source/perks/3.png" alt="" class="perks__blockPic">
                        </div>

                        <div class="perks__block">
                            <p>Наличе рабочих кейсов проверенные временем с ожидаемой доходность от 20%+</p>
                            <img src="<?php echo get_template_directory_uri()?>/assets/source/perks/4.png" alt="" class="perks__blockPic">
                        </div>

                        <div class="perks__block">
                            <p>Доступ к платным сервисам аналитики GuruFocus,Seeking Alpha,Barchart</p>
                            <img src="<?php echo get_template_directory_uri()?>/assets/source/perks/5.png" alt="" class="perks__blockPic">
                        </div>
                        
                        <div class="perks__block">
                            <p>Доступ к закрытому клубу трейдеров</p>
                            <img src="<?php echo get_template_directory_uri()?>/assets/source/perks/6.png" alt="" class="perks__blockPic">
                        </div>

                        <div class="perks__block">
                            <p>Еженедельные созвоны</p>
                            <img src="<?php echo get_template_directory_uri()?>/assets/source/perks/7.png" alt="" class="perks__blockPic">
                        </div>

                        <div class="perks__block">
                            <p>Реализация актуальных идей трейдерами</p>
                            <img src="<?php echo get_template_directory_uri()?>/assets/source/perks/8.png" alt="" class="perks__blockPic">
                        </div>
                        
                        <div class="perks__block">
                            <p>Экономия времени на поиск актуальной и структурированной информации по опционам</p>
                            <img src="<?php echo get_template_directory_uri()?>/assets/source/perks/9.png" alt="" class="perks__blockPic">
                        </div>


                        <div class="perks__block">
                            <p>Ценность предоставляемого  материала 5000$</p>
                            <img src="<?php echo get_template_directory_uri()?>/assets/source/perks/10.png" alt="" class="perks__blockPic">
                        </div>

                        <div class="perks__block">
                            <p>Окупаемсть курса от 4 месяцев</p>
                            <img src="<?php echo get_template_directory_uri()?>/assets/source/perks/11.png" alt="" class="perks__blockPic">
                        </div>
                            ...
                            <div class="canSlider__contentWrap">
                                <div class="canSlider__track">
                                    ...
                                    <div class="canSlider__block">
                                        ...
                                        <div class="canSlider__blockPic">
                                            <img height="630px" src="<?php echo get_template_directory_uri()?>/assets/source/can/imac.png" alt="">
                                            <div style="background-image: url(<?php echo get_template_directory_uri()?>/assets/source/can/test.jpg);" class="canSlider__blockPicMain"></div>
                                        </div>
                                    </div>
            ...
            <section class="program">
                ...
                <div class="program__bg" style="background-image: url(<?php echo get_template_directory_uri()?>/assets/source/program/bg.png);"></div>
            </section>
            ...
            <section class="offer">
                ...
                <img src="<?php echo get_template_directory_uri()?>/assets/source/offer/bg.png" alt="" class="offer__bg">
            </section>
            ...
            <section class="salles">
                <div class="container">
                    ...
                    <img class="salles__coin salles__coinLeft1" id="salles__coinNearly" src="<?php echo get_template_directory_uri()?>/assets/source/salles/left1.png" alt="">
                    <img class="salles__coin salles__coinLeft2" id="salles__coinFar" src="<?php echo get_template_directory_uri()?>/assets/source/salles/left2.png" alt="">
                    ...
                    <div class="prepod__content">
                        <div class="prepod__block">
                            <div class="prepod__pic" >
                                <img src="<?php echo get_template_directory_uri()?>/assets/source/prepod/1.png" alt="">
                            </div>
                        ...
                        <div class="prepod__block">
                            <div class="prepod__pic" >
                                <img src="<?php echo get_template_directory_uri()?>/assets/source/prepod/2.png" alt="">
                            </div>
                            <div class="prepod__name">
                                <h3>Илья</h3>
                            </div>
                        ...
                        <div class="prepod__block">
                            <div class="prepod__pic" >
                                <img src="<?php echo get_template_directory_uri()?>/assets/source/prepod/3.png" alt="">
                            </div>
                            <div class="prepod__name">
                                <h3>Василий</h3>
                            </div>
                ...
                <div class="container">
                    <div class="cases__title">
                        ...
                        <div class="cases__slider owl-carousel owl-theme">
                            <div class="cases__sliderItem" style="background-image: url(<?php echo get_template_directory_uri()?>/assets/source/cases/case.jpg);"></div>
                            <div class="cases__sliderItem" style="background-image: url(<?php echo get_template_directory_uri()?>/assets/source/cases/case.jpg);"></div>
                        </div>
                    </div>
                </div>
